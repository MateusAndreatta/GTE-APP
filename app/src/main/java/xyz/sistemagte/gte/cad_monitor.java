                ...
                if (!b) {
                    ...
                    StringRequest sr = new StringRequest(url, new Response.Listener<String>() {
                        ...
                        public void onErrorResponse(VolleyError error) {
                            Toast.makeText(cad_monitor.this, (getResources().getString(R.string.cepInvalido)), Toast.LENGTH_SHORT).show();
                        }
                    });
                    RequestQueue rq = Volley.newRequestQueue(cad_monitor.this);
                    rq.add(sr);
                }
            }
        });
