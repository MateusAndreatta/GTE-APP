...
public class ListagemCriancaMonitor extends AppCompatActivity implements SearchView.OnQueryTextListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_listagem_crianca_monitor);
        ...
        progressDialog = new ProgressDialog(ListagemCriancaMonitor.this);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, JSON_URL,
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError volleyError) {
                        ...
                        Toast.makeText(ListagemCriancaMonitor.this, volleyError.toString(), Toast.LENGTH_LONG).show();
                    }
                }) {
            @Override
    ...
    public boolean onQueryTextChange(String newText){
        ...
        listView.setAdapter(new ListViewCriancaAdm(listaQuery, ListagemCriancaMonitor.this));
        return true;
    }
