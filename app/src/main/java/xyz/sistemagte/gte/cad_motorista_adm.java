...
public class cad_motorista_adm extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cad_motorista_adm);
                ...
                if (!b) {
                    ...
                    StringRequest sr = new StringRequest(url, new Response.Listener<String>() {
                        ...
                        public void onErrorResponse(VolleyError error) {
                            Toast.makeText(cad_motorista_adm.this, (getResources().getString(R.string.cepInvalido)), Toast.LENGTH_SHORT).show();
                        }
                    });
                    RequestQueue rq = Volley.newRequestQueue(cad_motorista_adm.this);
                    rq.add(sr);
                }
            }
        });
            ...
            StringRequest stringRequest = new StringRequest(Request.Method.POST, HttpUrl,
                    new Response.Listener<String>() {
                        ...
                        public void onResponse(String ServerResponse) {
                            ...
                            if(ServerResponse.trim().equals("EmailCadastrado")){
                                Toast.makeText(cad_motorista_adm.this, R.string.emailCadastrado, Toast.LENGTH_SHORT).show();
                            }else{
                                // Showing response message coming from server.
                                Toast.makeText(cad_motorista_adm.this, getResources().getString(R.string.informacoesSalvasSucesso), Toast.LENGTH_SHORT).show();
                                Intent tela = new Intent(cad_motorista_adm.this, Login.class);
                                startActivity(tela);
                            }
                    ...
                    new Response.ErrorListener() {
                        ...
                        public void onErrorResponse(VolleyError volleyError) {
                            ...
                            Toast.makeText(cad_motorista_adm.this, volleyError.toString(), Toast.LENGTH_LONG).show();
                        }
                    }) {
                @Override
