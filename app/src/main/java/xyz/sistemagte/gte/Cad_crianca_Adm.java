                ...
                if (!b) {
                    ...
                    StringRequest sr = new StringRequest(url, new Response.Listener<String>() {
                        ...
                        public void onErrorResponse(VolleyError error) {
                            Toast.makeText(Cad_crianca_Adm.this, (getResources().getString(R.string.cepInvalido)), Toast.LENGTH_SHORT).show();
                        }
                    });
                    RequestQueue rq = Volley.newRequestQueue(Cad_crianca_Adm.this);
                    rq.add(sr);
                }
            }
        });
