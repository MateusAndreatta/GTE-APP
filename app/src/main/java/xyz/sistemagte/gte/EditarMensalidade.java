...
public class EditarMensalidade extends AppCompatActivity {
    ...
    private int idEmpresa, idResp,idMensalidade;
    ...
    String HttpUrl = "https://sistemagte.xyz/android/editar/editarMensalidade.php";
    ...
    String JsonUrlDados = "https://sistemagte.xyz/json/adm/ListarDadosMensalidade.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressDialog = new ProgressDialog(EditarMensalidade.this);
        ...
        Intent i = getIntent();
        idMensalidade = Integer.parseInt(i.getStringExtra("idM"));
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, HttpUrl,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String ServerResponse) {
                        ...
                        Toast.makeText(EditarMensalidade.this, getResources().getString(R.string.informacoesSalvasSucesso), Toast.LENGTH_SHORT).show();
                        Intent tela = new Intent(EditarMensalidade.this, Mensalidades_adm.class);
                        startActivity(tela);
                    }
                },
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError volleyError) {
                        ...
                        progressDialog.dismiss();
                        Toast.makeText(EditarMensalidade.this, volleyError.toString(), Toast.LENGTH_LONG).show();
                    }
                }) {
            @Override
                    ...
                    public void onResponse(String ServerResponse) {
                        try {
                            ...
                            if(CriancaListSpinner.isEmpty()){
                                Toast.makeText(EditarMensalidade.this, respSpinner.getSelectedItem().toString() + " " +  getString(R.string.nenhumaCriancaCadastrada), Toast.LENGTH_LONG).show();
                            }
    ...
    private void CarregarDados(){
        progressDialog.setMessage(getResources().getString(R.string.loadingDados));
        progressDialog.show();
        StringRequest stringRequest = new StringRequest(Request.Method.POST, JsonUrlDados,
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String ServerResponse) {
                        try {
                            ...
                            for (int i = 0; i < jsonArray.length(); i++) {
                                ...
                                String dia = jo.getString("dt_vencimento");
                                ...
                                valor.setText(jo.getString("valor_emitido"));
                                dtVencimento.setText(date);
                            }
                            progressDialog.dismiss();
                        } catch (JSONException e) {
                            progressDialog.dismiss();
